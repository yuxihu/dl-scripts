  ...
  do
    ...
    do
      ...
      do
        ...
        ENV="-x HOROVOD_HIERARCHICAL_ALLREDUCE=$HA -x HOROVOD_FUSION_THRESHOLD=$FSIZE -x HOROVOD_STALL_CHECK_DISABLE=1 -x NCCL_MIN_NRINGS=4 -x MXNET_USE_OPERATOR_TUNING=0"
        OPTIONS="--data-nthreads $DT --model resnet50_v1b --dtype float16 --batch-size 256 --lr 0.1 --lr-mode poly --save-frequency 0 --last-gamma"
